...
느긋하게 창밖을 바라보며 한적한 길거리를 바라보면, 적막한 거리는 오히려 깨끗하게 보인다.
...
톰은 가을의 공기를 들이켠 건조한 목을 축이기 위해 정수기를 향해 나아갔다. 
...
두 딸은 이제 초등학교 3학년과 1학년이다. 둘 다 학교가 끝나는 대로 여기 저기 학원을 다니느라 나름 바쁜 모양이다.
...
톰이 처음 이 집에 왔을 때 초등학생이었던 딸들은 어느새 시간이 흘러 대학생이 되었다.
부부 역시 다시 맞벌이를 시작하며 점점 바빠졌다.
집사 가족은 아침마다 분주하였고, 톰보다 일찍 아침을 시작하게 되었다.

그렇게 가족들은 자신의 일에 더 집중하게 되어만 가는 듯했고, 톰은 점점 늦게 일어나기 시작했다.
그런 하루들이 반복된 결과 톰은 저녁에 일어나는 것이 익숙해졌다. 이는 가족에게 어리광부리기를 불가능하게 만들었다.
예전에는 그렇게 챙겨줬으면서 갈수록 자신을 외면하는 듯한 느낌을 받는 톰. 
그래도 집에는 있게 해주니 그러려니 하지만, 가족에 대한 그리움은 식어만 가고 자연스럽게 혼자서 생활하는 시간이 늘어갔다. 오늘도 그렇게 혼자인 저녁을 맞이한 것이다.
...
어쩌면 지금 고픈 건 밥보단 가족의 관심이었다. 같이 살면서도 피어나는 묘한 그리움을 애써 눌러 담았다.
...
최근에는 예전보다 관심이 덜한 것 같긴 하다..
마지막으로 집사가 먼저 장난치고 놀아줬던 게 언제더라...
에이 모르겠다...! 뭐 어찌 됐든 만족스러운 생활이야!
```
...
가족들은 하던 일을 마치고 집에 돌아오면 누구 하나 빠질세라 톰에게 바깥 생활에 대한 이야기보따리를 풀어놓았다.
그래서 톰은 이제 집사들의 일과가 어떻게 되는지쯤은 이미 알고 있었다. 
...
톰의 일상은 캣타워에 올라가 고요함을 비집고 들려오는 시계 초침 소리를 자장가로 삼아 낮잠을 자거나, 집사가 사둔 장난감을 가지고 놀며 유유히 시간을 흘려보내는 것이 전부이다.
...
이상한 게 들어있진 않나 불안하기도 했지만 후각과 미각이 괜찮다고 판단하자 우려는 이내 식탐으로 변했다.

기름에 절여진 참치 살코기는 고소한 풍미와 함께 입 안에서 순식간에 부스러지며 식도를 넘어갔다. 
이미 여러번 먹어봤던 음식이지만 먹을 때마다 항상 만족스러운 식사를 보장해주었다.
...
길에서 생활하던 시절 종종 다른 길고양이와 함께 사냥한 먹이를 나눠먹기도 했던 톰이었다.

그러나 오늘은 안 된다. 모처럼의 일탈이다.
오늘 이 모험은 오로지 나만을 위한 것이다.
다른 고양이에게 배려를 베푸느라 나의 것을 희생할 수는 없다.
...
온전히 자기만의 자유를 찾아 돌아다닐 수 있었던 시절, 어쩌면 톰은 무의식적으로 그때의 시절이 그리워 했을지도 모른다.
...
제리는 작은 구멍으로 톰을 안내했다. 
톰은 자신의 눈앞에서 빠르게 움직이는 제리를 따라 전속력으로 구멍을 향해 달려갔다. 
...
집사에 대한 실망감에 도망쳐나오듯 뛰쳐나온 톰은 쉽사리 마음이 진정되지 않는다.
...
톰이 길고양이었던 시절, 상점가에는 톰에게 밥을 주는 수많은 집사가 있었다.
...
하지만 역시 지금 눈 앞의 집사는 길고양이 시절 밥을 챙겨주던 따뜻한 집사와는 다른 사람이었다.
...
먹을 것을 구하지 못한 것은 물론, 어디로 가야할지도 결정하지 못한 톰은 톰은 풀이 죽은 모습을 한 채 주변을 서성거리기 시작했다. 그때 누군가가 다가왔다. 
